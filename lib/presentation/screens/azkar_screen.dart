...
class AzkarScreen extends StatelessWidget {
  ...
  final List Azkar = [
    ...
    '''أَصْبَحْنَا وَأَصْبَحَ الْمُلْكُ لِلَّهِ، وَالْحَمْدُ لِلَّهِ، لاَ إِلَهَ إلاَّ اللَّهُ وَحْدَهُ
لاَ شَرِيكَ لَهُ، لَهُ الْمُلْكُ وَلَهُ الْحَمْدُ وَهُوَ عَلَى كُلِّ شَيْءٍ قَدِيرٌ، رَبِّ
أَسْأَلُكَ خَيْرَ مَا فِي هَذَا الْيَوْمِ وَخَيرَ مَا بَعْدَه وَأَعُوذُ بِكَ مِنْ شَرِّ مَا فِي
...
إِنِّي أَعُوذُ بِكَ مِنَ الْكُفْرِ، وَالفَقْرِ، وَأَعُوذُ بِكَ مِنْ عَذَابِ القَبْرِ، لاَ إِلَهَ إِلاَّ أَنْتَ''',
    '''حَسْبِيَ اللَّهُ لاَ إِلَهَ إِلاَّ هُوَ
...
الْعَظِيمِ''',
    ...
    ''' اللَّهُمَّ عَالِمَ الغَيْبِ وَالشَّهَادَةِ فَاطِرَ السَّمَوَاتِ وَالْأَرْضِ، رَبَّ كُلِّ شَيْءٍ وَمَلِيكَهُ، أَشْهَدُ أَنْ لاَ إِلَهَ إِلاَّ أَنْتَ، أَعُوذُ بِكَ مِنْ شَرِّ نَفْسِي، وَمِنْ شَرِّ الشَّيْطانِ وَشَرَكِهِ، وَأَنْ أَقْتَرِفَ عَلَى  نَفْسِي سُوءاً''',
    ...
    'أَصْبَحْنَا وَأَصْبَحَ الْمُلْكُ لِلَّهِ رَبِّ الْعَالَمِينَ([22])، اللَّهُـمَّ إِنِّي أَسْأَلُكَ خَيْرَ هَذَا الْيَوْمِ([23]):فَتْحَهُ، وَنَصْرَهُ، وَنورَهُ، وَبَرَكَتَهُ، وَهُدَاهُ، وَأَعُوذُ بِكَ مِنْ شَرِّ مَا فِيهِ وَشَرِّ مَا بَعْدَهُ',
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          title: Text(
            ...
            style: TextStyle(fontSize: 25, color: AppLightColors.deepOrange),
          ),
        ),
        body: ListView.builder(
          itemCount: min(Azkar.length, repeat.length),
              ...
              child: Column(
                ...
                children: [
                  Text(
                    Azkar[index],
                    style: TextStyle(
                        fontSize: 25, color: AppLightColors.whiteColor),
                  ),
                  SizedBox(
                    height: 5,
                  ),
                  Text(
                    'مرات التكرار ${repeat[index]}',
                    style: TextStyle(fontSize: 20, color: AppLightColors.gray),
                  ),
                ],
              ),
            );
